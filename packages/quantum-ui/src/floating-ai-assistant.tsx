    ...
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-40">
        <div 
          ...
          style={{
            left: Math.max(0, mousePosition.x - 100),
            top: Math.max(0, mousePosition.y - 100),
          }}
        />
        <div 
          className="absolute w-1 h-1 bg-purple-400 rounded-full opacity-40 animate-pulse floating-particle"
          style={{
            left: Math.min(window.innerWidth - 10, mousePosition.x + 80),
            top: Math.max(0, mousePosition.y - 80),
          }}
        />
      </div>
